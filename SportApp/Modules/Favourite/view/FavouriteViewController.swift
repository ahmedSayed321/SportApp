...
class FavouriteViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        favsTable.register(UINib(nibName: "CustomLeagueTableViewCell", bundle:nil),forCellReuseIdentifier: "CustomLeagueTableViewCell")
...
extension FavouriteViewController : UITableViewDelegate ,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = favsTable.dequeueReusableCell(withIdentifier: "CustomLeagueTableViewCell", for: indexPath) as! CustomLeagueTableViewCell
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete{
            favPresenter.deleteLeagueFromFav(leagueKey: favPresenter.getLeagueAt(index: indexPath.row, sport: favPresenter.sport ?? .football)!.leagueKey)
            favsTable.reloadData()
        }
